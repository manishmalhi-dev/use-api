...
class ProductEditBottomSheet extends StatefulWidget {
  CollectionGetData dataList;
  String category;
   ProductEditBottomSheet({super.key, required this.dataList, required this.category});
...
class _ProductEditBottomSheetState extends State<ProductEditBottomSheet> {
  ...
  Widget build(BuildContext context) {
    return isLoading==true?SizedBox(height: MediaQuery.of(context).size.height/2, width: double.infinity,child: Center(child: CircularProgressIndicator(),)):Form(
      key: newKey,
      child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Center(child: Text(widget.category,style: TextStyle(color: Colors.black, fontSize: 22 , fontWeight: FontWeight.w400),)),
                      ),
                    )
                  ],
                ),
